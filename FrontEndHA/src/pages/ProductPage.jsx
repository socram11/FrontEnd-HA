...
const ProductCard = ({ product }) => {
  return (
    <div className="card h-100 border-0"> {/* Removido shadow-sm y rounded-lg */}
      <img
      ...
      <div className="card-body text-center d-flex flex-column justify-content-between">
        ...
        {!product.isSoldOut && (
             <button className="btn btn-dark w-100 py-2 text-sm fw-medium mt-auto border-0"> {/* border-0 para plano */}
                Ver Producto
             </button>
        )}
      </div>
      ...
      <main className="flex-grow-1 p-3 container-md mx-auto">
        ...
        <div className="bg-white d-flex flex-column flex-md-row justify-content-center p-4 p-md-5 mb-5 mt-5">
          ...
          <div className="col-12 col-md-6 d-flex justify-content-center align-items-center p-3 p-md-4 mb-4 mb-md-0">
            <div className="position-relative w-100 bg-light d-flex justify-content-center align-items-center overflow-hidden" style={{ height: '400px' }}>
              ...
              <div className="position-absolute bottom-0 start-50 translate-middle-x d-flex justify-content-center pb-3">
                <span className="d-block me-2 bg-secondary" style={{ width: '8px', height: '8px', borderRadius: '50%' }}></span>
                <span className="d-block me-2 bg-success" style={{ width: '8px', height: '8px', borderRadius: '50%' }}></span> {/* Activo */}
                <span className="d-block bg-secondary" style={{ width: '8px', height: '8px', borderRadius: '50%' }}></span>
              </div>
              {/* Flechas de navegación (opcional) */}
              <button className="btn btn-sm btn-light position-absolute start-0 top-50 translate-middle-y ms-2 border-0">&lt;</button>
              <button className="btn btn-sm btn-light position-absolute end-0 top-50 translate-middle-y me-2 border-0">&gt;</button>
            </div>
          </div>
          ...
          <div className="col-12 col-md-6 p-3 p-md-4 d-flex flex-column">
            <div>
              ...
              <p className="fs-6 text-success mb-4 d-flex align-items-center">
                ...
                <i className="bi bi-truck me-2"></i> Disponible para envío a domicilio
              </p>
